...
class MAKHIA_API UCrouchSystemComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION(BlueprintCallable, Category = "Crouch System", meta = (ToolTip = "Returns the MKHPlayerCharacter owner"))
