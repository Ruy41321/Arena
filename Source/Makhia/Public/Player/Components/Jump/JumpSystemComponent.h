...
class MAKHIA_API UJumpSystemComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION(BlueprintCallable, Category = "Jump System", meta = (ToolTip = "Returns the MKHPlayerCharacter owner"))
