...
class MAKHIA_API UBasicMovementComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION(BlueprintCallable, Category = "Basic Movement", meta = (ToolTip = "Returns the MKHPlayerCharacter owner"))
