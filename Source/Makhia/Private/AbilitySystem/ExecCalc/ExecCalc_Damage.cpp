	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	FMKHGameplayEffectContext* RPGContext = FMKHGameplayEffectContext::GetEffectContext(EffectContextHandle);

	// Get raw damage from the SetByCaller data passed when applying the GameplayEffect
	float Damage = EffectSpec.GetSetByCallerMagnitude(MKHGameplayTags::Combat::Data_Damage);
