...
public:
	...
	void BindAbilityActions(URPGInputConfig* InputConfig, const FGameplayTag& TagFilter, UserClass* Object, PressedFuncType PressedFunc, ReleasedFuncType ReleasedFunc);

};

template<class UserClass, typename PressedFuncType, typename ReleasedFuncType>
void URPGSystemInputComponent::BindAbilityActions(URPGInputConfig* InputConfig, const FGameplayTag& TagFilter,
