...
struct StaminaStatics
{
	...
	{
		// Source Defines
		DEFINE_ATTRIBUTE_CAPTUREDEF(URPGAttributeSet, Stamina, Source, true);
		DEFINE_ATTRIBUTE_CAPTUREDEF(URPGAttributeSet, MaxStamina, Source, true);
		DEFINE_ATTRIBUTE_CAPTUREDEF(URPGAttributeSet, DodgeStaminaCost, Source, true);
	}
};
